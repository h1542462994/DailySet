...
class DailyTypography(
    ...
    var buttonText by mutableStateOf(buttonText, structuralEqualityPolicy())
        internal set
    var titleText by mutableStateOf(titleText, structuralEqualityPolicy())
        internal set
    ...
    fun copy(
        ...
        titleText: TextStyle = this.titleText,
        subTitleText: TextStyle = this.subTitleText
    ): DailyTypography {
        return DailyTypography(
            linkText = linkText,
